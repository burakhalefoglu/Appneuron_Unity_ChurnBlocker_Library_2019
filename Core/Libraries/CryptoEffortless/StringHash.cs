namespace AppneuronUnity.Core.Libraries.CryptoEffortless
{
    ...
    using System.Text;
    using static AppneuronUnity.Core.Libraries.CryptoEffortless.Bytes;

    /// <summary>
    /// Defines the <see cref="StringHash" />.
    /// </summary>
    internal static class StringHash
    {
        ...
        /// <returns>The encrypted string.</returns>
        public static string Encrypt(string clearString, string password, string salt, string iv,
            KeySize keySize,
            int iterationCount)
        {
        ...
        KeySize keySize, int iterationCount)
        {
        ...
        /// Create a salt.
        /// </summary>
        /// <param name="numBytes">The numBytes<see cref="int"/>.</param>
